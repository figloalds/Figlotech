...
namespace Figlotech.Core.Autokryptex.Legacy {
    public sealed class LegacyAutokryptexEncryptor : IEncryptionMethod {
        readonly AggregateEncryptor encryptor = new AggregateEncryptor();

        readonly byte[] instancePassword;
        String encodedPassword;
        readonly TwoWayRsaEncryptor TwoWayEncryptor;
        readonly LegacyCrossRandom cr;
